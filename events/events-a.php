...
<?php include('headbar-aa.php');?>
  ...
  <tr>
    <td width="1%" BGCOLOR="#FFFF99" style="color:#330000">  <div id="menu_bar"><center>ข้อมูล เจ้าหน้าที่ผู้มีสิทธิอนุมัติ</center></td>
  ...
  <div class="main-content" style="margin-top: 20px; width: 95%;">
    ...
    <div class="block">
      <div class="navigation">
        <a href="events-a.php?y=<?php echo $year - 1; ?>&m=<?php echo $month; ?>">ปีก่อนหน้า</a>
        <a href="events-a.php?y=<?php echo ($month - 1 == 0) ? $year - 1 : $year; ?>&m=<?php echo ($month - 1 == 0) ? 12 : $month - 1; ?>">เดือนก่อนหน้า</a>
        <a href="events-a.php?y=<?php echo ($month + 1 == 13) ? $year + 1 : $year; ?>&m=<?php echo ($month + 1 == 13) ? 1 : $month + 1; ?>">เดือนถัดไป</a>
        <a href="events-a.php?y=<?php echo $year + 1; ?>&m=<?php echo $month; ?>">ปีถัดไป</a>
  <?php
      $currentMonthInfo = getdate(time());
  ?>

        <a href="events-a.php?y=<?php echo $currentMonthInfo["year"]; ?>&m=<?php echo $currentMonthInfo["mon"]; ?>">เดือนปัจจุบัน </a>
      </div>
  <?php
  ...
  ?>
          <tr data-group-id="<?php echo $e['group_id'];?>">
            ...
            <?php if($_SESSION['UserStatus'] == "authority-apply"){ ?>
              ...
              <a href="events-delete-a.php?group_id=<?php echo $e["group_id"]; ?>" class="btn" style="margin-bottom:10px;" >ลบออกจากหน้าจอ</a>
            <?php }else{
