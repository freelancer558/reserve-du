...
<ul>
   ...
   <li><a href="index1.php"><span>ตรวจสอบสถานะการใช้งาน</span></a></li>
</ul>
</div>
<div style="clear:both; margin: 0 0 1px 0;">&nbsp;</div>
  ...
  <tr>
    <td width="1%" ><div id="menu_bar"><center>ข้อมูล ผู้ดูแลระบบ</center></td>
...
<select name="select" size="1" onChange="namosw_goto_byselect(this, 'self')">
			...
			<option value='index1.php'>pH meter</option> 
			<option value='index1-2.php'>Microscope</option>
			<option value='index1-3.php'>UV Spectrophotometer</option>
			<option value='index1-4.php'>Centrifuge</option>
			<option value='index1-5.php'>Thermal Cycler</option>
			<option value='index1-6.php'>Drying Oven with Natural</option>
</select>
