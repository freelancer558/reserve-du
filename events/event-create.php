...
<ul>
   ...
   <li><a href="../authority/HowToReserve-Au.php"><span>ระเบียบปฏิบัติ</span></a>
   </li>
    ...
    <form method="POST" action="index.php" >
      ...
      ?>
          ...
          <div class="eastern" style="width:460px;margin-top: 10px;">
            <h3>สิ้นสุดการจอง</h3>
            <p style="float:left;">
              <label>วัน <em>(dd-mm-yyyy)</em></label>
              <br/>
...
<div id='cssmenu'>
<ul>
   <li><a href='../authority/AllDurable-Au.php'><span>เครื่องมือวิทยาศาสตร์ทั้งหมด</span></a></li>
   <li><a href='../authority/AllDurable-Au.php'><span>ค้นหาเครื่องมือวิทยาศาสตร์</span></a></li>
</ul>
</div>
</td></tr>
...
<ul>
   ...
   <ul>
      ...
      <li><a href='../authority/News1.php'><span>ข่าวสาร</span></a></li>
