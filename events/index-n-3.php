...
<select name="select" size="1" onChange="namosw_goto_byselect(this, 'self')">
			...
			<option value='index-n.php'>pH meter</option> 
			<option value='index-n-2.php'>Microscope</option>
			<option value='index-n-3.php'>UV Spectrophotometer</option>
			<option value='index-n-4.php'>Centrifuge</option>
			<option value='index-n-5.php'>Thermal Cycler</option>
			<option value='index-n-6.php'>Drying Oven with Natural</option>
</select>
