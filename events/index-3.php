  ...
  $(document).ready(function() {
    ...
    $('#calendar').fullCalendar({
      ...
      select: function(start, end, allDay) {
        ...
        window.location = 'events-create.php?start_at='+ output;
      },
...
<table width="100%" border="0" BORDERCOLOR="CCCCCC"align="center" cellpadding="0" cellspacing="0" >
  ...
  <tr>
    ...
    <div id="navbar"> <ul>
    <li>   <a href="../authority/admin_page1.php">หน้าแรก</a>   </li>
    <li>   <a href="../authority/HowToReserve-A.php">ระเบียบปฏิบัติ</a>    </li>
      <li> <a href="../authority/Contact-A.php">ตรวจสอบการติดต่อจากผู้ใช้</a>    </li></ul>
  </div></th>
  </tr>
...
<center> เครื่องมือ : UV Spectrophotometer <br>
<select name="select" size="1" onChange="namosw_goto_byselect(this, 'self')">
            <option value=''>-----กรุณาเลือกเครื่องมือ------</option>
			<option value='index.php'>pH meter</option> 
			<option value='index-2.php'>Microscope</option>
			<option value='index-3.php'>UV Spectrophotometer</option>
			<option value='index-4.php'>Centrifuge</option>
			<option value='index-5.php'>Thermal Cycler</option>
			<option value='index-6.php'>Drying Oven with Natural</option>
</select>
