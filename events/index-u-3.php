  ...
  $(document).ready(function() {
    ...
    $('#calendar').fullCalendar({
      ...
      select: function(start, end, allDay) {
        ...
        window.location = 'events-create-u.php?start_at='+ output;
      },
...
<select name="select" size="1" onChange="namosw_goto_byselect(this, 'self')">
			...
			<option value='index-u.php'>pH meter</option> 
			<option value='index-u-2.php'>Microscope</option>
			<option value='index-u-3.php'>UV Spectrophotometer</option>
			<option value='index-u-4.php'>Centrifuge</option>
			<option value='index-u-5.php'>Thermal Cycler</option>
			<option value='index-u-6.php'>Drying Oven with Natural</option>
</select>
