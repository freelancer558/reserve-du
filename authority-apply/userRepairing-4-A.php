...
<title>การแจ้งซ่อมจากผู้ใช้ที่ยืนยัยแล้ว</title>
...
$strSQL = "SELECT * FROM userdurablereport WHERE Active='Yes'  ";
...
$strSQL .=" order  by RId DESC LIMIT $Page_Start , $Per_Page";
$objQuery  = mysql_query($strSQL);
?>
...
<td colspan="6"> <div id="head_content">
	  การแจ้งซ่อมจากผู้ใช้ที่ทำการตรวจเช็คแล้ว</div></td>
</tr>

  <tr>

    <th width="220"> <div align="center">หมายเลขการแจ้งซ่อมจากผู้ใช้ </div></th>
    <th width="150"> <div align="center">เครื่องมือ </div></th>
    <th width="220"> <div align="center">รายละเอียด </div></th>		    
...
$facid = $objResult["DurableArticleSetId"];
	...
	{
	?>
		<td><div align="left"><?php echo $objResult2["DurableArticleSetEnglishName"];?></div></td>
<?php
	}
	?>

    <td><div align=""><?php echo iconv_substr( $objResult["Detail"],0,50, "UTF-8");?></div></td>



   <td align="" width="80px"><a href="userRepairing-5-A.php?RId=<?php echo $objResult["RId"];?>">รายละเอียด</a></td>
