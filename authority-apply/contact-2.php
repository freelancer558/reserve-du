...
?>
	<form name="frmEdit" method="post" action="contact-4.php?Id=<?php echo $_GET["Id"];?>" enctype="multipart/form-data"  onSubmit="JavaScript:return fncSubmit();">
	<table width="600" border="0"  id="box-table-a">
  <tr> 
  <tr>
<td colspan="8"> <div id="head_content">
	  แก้ไขรายละเอียดติดต่อเจ้าหน้าที่ : <?php echo$objResult["Name"];?></div></td>
</tr>
	...
	<td><textarea name="txtAddress" cols="40" rows="5" value="<?php echo $objResult["Address"];?>"><?php echo $objResult["Address"];?></textarea>*</td>
</tr>

	<tr>
    <th width=""> <div align="left">อีเมล์ :  </div></th>
	<td><input type="text" name="txtEmail" value="<?php echo $objResult["Email"];?>">*</td>
</tr>

<tr>
    <th width=""> <div align="left">หมายเลขโทรศัพท์ (สำนักงาน) : </div></th>
	<td><input type="text" name="txtphone1" value="<?php echo $objResult["phone1"];?>">*</td>
</tr>

	<tr>
    <th width=""> <div align="left">หมายเลขโทรศัพท์ (เคลื่อนที่) :  </div></th>
	<td><input name="txtphone2" value="<?php echo $objResult["phone2"];?>">*</td>
</tr>

<tr>
    <th width=""> <div align="left">หมายเลขแฟกซ์ :  </div></th>
	<td>
<input name="txtPhoneFax"value="<?php echo $objResult["PhoneFax"];?>">*</td>
</tr>
