...
<?php   $date1 = $_POST['date1'];
	   $date2 = $_POST['date2']; ?>
	           ...
	           <span class="txtBlack16">&nbsp;&nbsp;&nbsp;&nbsp;รายงานสรุปการใช้งานเครื่องมือวิทยาศาสตร์ &nbsp;เริ่มวันที่ 
      <?php echo $date1; ?> 
      ถึง วันที่
...
$strSQL = "SELECT  * FROM reserve WHERE (Date between '$date1' and '$date2' and status ='approved') order by Date ASC";
