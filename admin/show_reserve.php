...
$objConnect = mysql_connect("localhost","root","") or die("Error Connect to Database");
$objDB = mysql_select_db("project");
$strSQL = "SELECT DISTINCT group_id,DurableArticleSet FROM reserve WHERE status='approved'";
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
<td colspan="8"> <div id="head_content">
	  แก้ไขเปลี่ยนแปลงการจอง</div></td>
</tr>

<tr >
<th width="130"> <div align="center"> -</div></th>
...
?>
<tr>
<td><div align="center"><?php echo $objResult["group_id"];?></div></td>
<td><center>		            </center></td>
<td><center><?php echo $objResult["DurableArticleSet"];?></center></td>
<td><center><?php echo $objResult["Date"];?></center></td>
<td><center><?php echo $objResult["end_date"];?>,<?php echo $objResult["phone2"];?></center></td>
