...
<head>
<META HTTP-EQUIV="Refresh"CONTENT="2;URL=durable-fail-U.php">
...
<?php include('headbar.php'); ?>
  <tr>
    <td width="1%" BGCOLOR="#FFFF99" style="color:#330000"> <div id="menu_bar"><center>ข้อมูล User</center></td>
...
<?php 
		...
		$objConnect = mysql_connect("localhost","root","") or die("Error Connect to Database");
		$objDB = mysql_select_db("project");
		$strSQL = "INSERT INTO userdurablereport ";
		$strSQL .="(DurableArticleSetId,Detail) ";
$strSQL .="VALUES ";
...
?>
<a href="durable-fail-U.php"><center>ทำการบันทึกเสร็จสิ้น <br> หากไม่มีการเปลี่ยนหน้าอัตโนมัติ  <br> กรุณาคลิกที่นี้</a></center>
</tr></table>
