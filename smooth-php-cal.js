(function($){
    ...
    $.fn.smoothPhpCalendar = function(opts){
		...
		function onOpenningDayEventAnimationComplete(options, dayOfMonth) 
		{
			...
			var reservBtn 	   = $("<p><a href='event-create.php?start_at="+startAt+"'>Reserv</a></p>").addClass('reservBtn');
			var div = $('<div></div>').css({
			...
			eventListContainer.append('<table class="table table-striped"><thead><th>username</th><th>Date Reserv</th><th>Time Reserv</th><th>End Date Reserv</th><th>End Time Reserv</th><th>Products</th></thead><tbody></tbody></table>')
