...
$pdf=new PDF();
//Column titles
$header=array('Id','DurableArticleSet','Status','StartDate','EndDate');
//Data loading

//*** Load MySQL Data ***//
$objConnect = mysql_connect("localhost","root","1234") or die("Error Connect to Database");
$objDB = mysql_select_db("project");
$strSQL = "SELECT `reserve`.`ID`, `reserve`.`DurableArticleSet`, `reserve`.`Status`, `reserve`.`Date`, `reserve`.`end_date`  FROM reserve";
...
$pdf->Cell(0,5,iconv( 'UTF-8','TIS-620','ตารางการออกรายงาน  : การจอง'),0,1,"C");
$pdf->Ln(10);
